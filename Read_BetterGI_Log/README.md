...
2. **上传日志** - 拖放BetterGI日志文件（文件名以`better-genshin-impact`开头）
 - BetterGI日志文件所在位置如下
   ...
   - 或使用BGI打开目录
   - <img width="905" height="599"src="https://github.com/user-attachments/assets/615087a5-eead-4eb8-8028-4bfe74d9b8ff" />
...
## 📋 更新日志
### 20260904
- M鍵 统计拾取物 支援 全角逗号、英文逗号、空白字符
### 20260903
- 适配部分日志
 - 检测路线文件格式错误(鋤地一條龍2.13.0)
### 20260830
- 适配部分BGI0.64.0日志
- 38.已达到总运行限时(采集CD管理3.1.0)
### 20260829
 - 修改"路线多次卡死，放弃此路线！警告"觸發羅輯
 - 适配部分BGI0.64.0日志
 - 队伍資訊增加 是否有開啟光柱拾取模式
### 20260808、20260809、20260824
 - 适配部分BGI0.63.0日志
### 20260801
 - 适配部分日志
   - 检测到复苏按钮，点击 or 复苏完成
### 20260730
 - 终点坐标异常，不记录放入J键隐藏零统计被隐藏關鍵字中
 - 适配部分日志
   - 接近限制时间，等待X分钟
### 20260729
 - J键隐藏零统计时，包含"自动吃药"、"使用复活料理"、"使用回血料理"的任务不会被隐藏
 - 增加錯誤&其他訊息
   - 视角转动超时
